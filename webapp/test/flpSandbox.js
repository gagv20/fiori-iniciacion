		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices list",
									"targetURL": "#gabrielpracticeinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gabrielpracticeinvoices-display": {
								"semanticObject": "gabrielpracticeinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gabrielpractice.invoices",
									"url": sap.ui.require.toUrl("gabrielpractice/invoices")
								}
							}
						}
					}
